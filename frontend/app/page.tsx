    ...
    <MarketingShell>
      <section className="relative overflow-hidden border-b border-[#ece2e6] bg-[linear-gradient(180deg,#faf6f0_0%,#fcfaf6_100%)] pt-10 sm:pt-14 lg:pt-14">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-8 lg:px-12">
          <div className="grid items-center gap-7 py-2 sm:gap-8 sm:py-3 lg:grid-cols-[0.88fr_1.12fr] lg:gap-10 lg:py-4">
            <div className="max-w-[35rem]">
              ...
              <h1 className="mt-5 max-w-[12.8ch] text-[1.82rem] font-black leading-[0.97] tracking-[-0.06em] text-[#34186f] sm:mt-6 sm:max-w-[14.2ch] sm:text-[2.38rem] lg:text-[2.82rem]">
              ...
              <p className="mt-5 max-w-[31rem] text-[0.92rem] leading-[1.9] text-[#6d7d8f] sm:mt-6 sm:text-[0.98rem] sm:leading-[2]">
              ...
              <div className="mt-8 max-w-[37rem] overflow-hidden rounded-[1.2rem] border border-[#ebe1df] bg-white/96 shadow-[0_12px_24px_rgba(10,37,64,0.045)] sm:mt-10 sm:max-w-[38rem] lg:max-w-[39rem]">
                <div className="grid grid-cols-3 bg-white">
                  {heroStats.map((stat) => (
                    <div
                      key={stat.label}
                      className="border-r border-[#ebe1df] px-4 py-3 last:border-r-0 sm:px-7 sm:py-[1.05rem]"
                    >
                      <div className="whitespace-nowrap text-[0.92rem] font-extrabold leading-none tracking-[-0.05em] text-[#2d1870] sm:text-[1.14rem] lg:text-[1.22rem]">
                        {stat.value}
                      </div>
                      <div className="mt-2 whitespace-nowrap text-[0.48rem] font-medium uppercase tracking-[0.14em] text-[#9aa7b6] sm:text-[0.56rem] sm:tracking-[0.18em]">
                        {stat.label}
                      </div>
                    </div>
                  ))}
            ...
            {serviceCards.map((card, index) => (
              <Reveal key={card.slug} delay={index * 0.04}>
                <Link
                  ...
                  className={[
                    "flex min-h-[15rem] flex-col rounded-[1.55rem] border px-5 py-5 shadow-[0_16px_34px_rgba(10,37,64,0.04)] transition hover:-translate-y-1 sm:px-6 sm:py-6",
                    index % 2 === 1
                ...
                >
                  <div
                    className={[
                      "inline-flex w-fit rounded-full px-4 py-2 text-[0.68rem] font-semibold uppercase tracking-[0.22em]",
                      index % 2 === 1
                  ...
                  <h3 className="mt-5 max-w-[12ch] text-[1.2rem] font-bold leading-[1.14] tracking-[-0.04em]">
                    {card.title}
                  </h3>
                  <p className={["mt-4 text-[0.92rem] leading-7", index % 2 === 1 ? "text-white/76" : "text-[#66788c]"].join(" ")}>
                    {card.summary}
                  </p>
                  <div
                    className={[
                      "mt-auto pt-5 text-[0.72rem] font-semibold uppercase tracking-[0.22em]",
      ...
      <section className="bg-[linear-gradient(180deg,#f9f4ed_0%,#f7f2ea_100%)] py-14 sm:py-18">
        <div className="mx-auto max-w-7xl px-4 sm:px-8 lg:px-12">
          <Reveal>
      ...
      <section className="bg-[linear-gradient(180deg,#f8f2ea_0%,#f4eee6_100%)] py-14 sm:py-18">
        <div className="mx-auto max-w-7xl px-4 sm:px-8 lg:px-12">
          <Reveal>
            <div className="rounded-[1.65rem] border border-[#ece2e6] bg-white px-5 py-6 shadow-[0_18px_42px_rgba(10,37,64,0.05)] sm:rounded-[1.9rem] sm:px-10 sm:py-8 lg:px-12">
